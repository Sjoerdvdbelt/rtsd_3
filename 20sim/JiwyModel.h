...
/* This file describes the model functions
   ...
   The model itself is the JiwyModel.cpp file
*/
#ifndef JiwyModel_H
#define JiwyModel_H
...
class JiwyModel: virtual public Submodel20sim
{
	public:
		enum stateflags_JiwyModel {initialrun, mainrun, finished};

		/**
		 * JiwyModel constructor
		 */
		JiwyModel(void);

		/**
		 * JiwyModel destructor
		 */
		virtual ~JiwyModel(void);

		/**
		 * JiwyModel Initialization of the model and calculation of the values for the start time t
	...
	private:
		...
		static const size_t m_timeevent_size = 4;
