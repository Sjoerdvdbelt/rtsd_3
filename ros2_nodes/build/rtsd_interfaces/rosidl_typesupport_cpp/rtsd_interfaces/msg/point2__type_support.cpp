...
static const _Point2_type_support_symbol_names_t _Point2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtsd_interfaces, msg, Point2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtsd_interfaces, msg, Point2)),
  }
};
...
{
  return &::rtsd_interfaces::msg::rosidl_typesupport_cpp::Point2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtsd_interfaces, msg, Point2)() {
  return get_message_type_support_handle<rtsd_interfaces::msg::Point2>();
}
